'''
Configuration script for Enformer Predictor
...
- Inside container:             "Enformer_20251128-180629_TZ"  (sortable, human-readable)
- Outside container (Dev mode): "Enformer_dev"
'''
